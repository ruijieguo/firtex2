 ...
 *
 */
#ifndef __BINARYFILE_WIN32IMPL_H
#define __BINARYFILE_WIN32IMPL_H
...
public:
     ...
     */
    virtual void open(const tstring &filename,
     ...
     */
    bool isFileOpen(void) const{return(m_handle != NULL);}
...
protected:	
    HANDLE m_handle;	// File handle for this file.
