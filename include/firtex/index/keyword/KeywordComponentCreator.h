...
#ifndef __FX_KEYWORDCOMPONENTCREATOR_H
#define __FX_KEYWORDCOMPONENTCREATOR_H
...
class KeywordComponentCreator : public FieldComponentCreator,
                                public FX_NS(utility)::Singleton<KeywordComponentCreator>
{
public:
    KeywordComponentCreator();
    ~KeywordComponentCreator();
...
protected:
    DECLARE_LAZY_SINGLETON(KeywordComponentCreator);
...
#endif //__FX_KEYWORDCOMPONENTCREATOR_H
