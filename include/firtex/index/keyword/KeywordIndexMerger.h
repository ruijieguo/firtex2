...
#ifndef __FX_KEYWORDINDEXMERGER_H
#define __FX_KEYWORDINDEXMERGER_H
...
class KeywordIndexMerger : public FieldMerger
{
public:
...
DEFINE_TYPED_PTR(KeywordIndexMerger);

FX_NS_END

#endif //__FX_KEYWORDINDEXMERGER_H
