...
// Created	: 2010-07-07 23:20:31

#ifndef __FX_REQPROHQUERYEXECUTOR_H
#define __FX_REQPROHQUERYEXECUTOR_H
...
class ReqProhQueryExecutor : public QueryExecutor
{
public:
    ReqProhQueryExecutor(FeatureProviderPtr& pProvider,
                         FX_NS(utility)::PoolPtr& pPool,
                         const QueryExecutorPtr& pReqExe,
                         const QueryExecutorPtr& pProhExe);
    ~ReqProhQueryExecutor();
...
protected:
    ...
    QueryExecutorPtr m_pProhExecutor;
    docid_t m_lastDocId;
...
////////////////////////////////////////////////////
//
inline void ReqProhQueryExecutor::doGetMatchedDoc(MatchedDoc& matchedDoc)
{
...
#endif //__FX_REQPROHQUERYEXECUTOR_H
