...
static int r_mark_regions(struct SN_env * z) {
    ...
    {   int c = z->c; /* do, line 56 */
        ...
        lab3:
            ...
            while(1) { /* gopast, line 66 */
                if (!(in_grouping(z, g_v, 97, 251))) goto lab4;
                break;
            lab4:
                if (z->c >= z->l) goto lab0;
                z->c++; /* gopast, line 66 */
    ...
    {   int c = z->c; /* do, line 69 */
        ...
        while(1) { /* gopast, line 70 */
            if (!(out_grouping(z, g_v, 97, 251))) goto lab7;
            break;
        lab7:
            if (z->c >= z->l) goto lab5;
            z->c++; /* gopast, line 70 */
        ...
        while(1) { /* gopast, line 71 */
            if (!(in_grouping(z, g_v, 97, 251))) goto lab8;
            break;
        lab8:
            if (z->c >= z->l) goto lab5;
            z->c++; /* gopast, line 71 */
        ...
        while(1) { /* gopast, line 71 */
            if (!(out_grouping(z, g_v, 97, 251))) goto lab9;
            break;
        lab9:
            if (z->c >= z->l) goto lab5;
            z->c++; /* gopast, line 71 */
