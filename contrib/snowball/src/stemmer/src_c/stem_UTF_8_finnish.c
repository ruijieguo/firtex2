...
static int r_possessive(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 3:
            ...
            break;
        case 4:
            if (z->c <= z->lb || z->p[z->c - 1] != 97) return 0;
            ...
            break;
        case 5:
            if (z->c <= z->lb || z->p[z->c - 1] != 164) return 0;
            ...
            break;
        case 6:
            if (z->c <= z->lb || z->p[z->c - 1] != 101) return 0;
...
static int r_i_plural(struct SN_env * z) {
    {   int m3; /* setlimit, line 154 */
        ...
        z->c = z->l - m;
        z->ket = z->c; /* [, line 154 */
        if (z->c <= z->lb || (z->p[z->c - 1] != 105 && z->p[z->c - 1] != 106)) { z->lb = m3; return 0; }
...
static int r_t_plural(struct SN_env * z) {
    ...
    {   int m3; /* setlimit, line 165 */
        ...
        z->c = z->l - m;
        z->ket = z->c; /* [, line 165 */
        if (z->c <= z->lb || z->p[z->c - 1] != 97) { z->lb = m3; return 0; }
