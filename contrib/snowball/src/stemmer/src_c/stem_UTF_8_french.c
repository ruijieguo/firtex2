...
static int r_mark_regions(struct SN_env * z) {
    ...
    {   int c = z->c; /* do, line 56 */
        ...
        lab3:
            ...
            while(1) { /* gopast, line 66 */
                if (!(in_grouping_U(z, g_v, 97, 251))) goto lab4;
                break;
            lab4:
                {   int c = skip_utf8(z->p, z->c, 0, z->l, 1);
                    if (c < 0) goto lab0;
    ...
    {   int c = z->c; /* do, line 69 */
        ...
        while(1) { /* gopast, line 70 */
            if (!(out_grouping_U(z, g_v, 97, 251))) goto lab7;
            break;
        lab7:
            {   int c = skip_utf8(z->p, z->c, 0, z->l, 1);
                if (c < 0) goto lab5;
        ...
        while(1) { /* gopast, line 71 */
            if (!(in_grouping_U(z, g_v, 97, 251))) goto lab8;
            break;
        lab8:
            {   int c = skip_utf8(z->p, z->c, 0, z->l, 1);
                if (c < 0) goto lab5;
        ...
        while(1) { /* gopast, line 71 */
            if (!(out_grouping_U(z, g_v, 97, 251))) goto lab9;
            break;
        lab9:
            {   int c = skip_utf8(z->p, z->c, 0, z->l, 1);
                if (c < 0) goto lab5;
...
static int r_postlude(struct SN_env * z) {
    ...
    while(1) { /* repeat, line 75 */
        int c = z->c;
        z->bra = z->c; /* [, line 77 */
        if (z->c + 0 >= z->l || z->p[z->c + 0] >> 5 != 2 || !((35652096 >> (z->p[z->c + 0] & 0x1f)) & 1)) among_var = 4; else
        ...
        switch(among_var) {
            ...
            case 3:
                {   int ret;
                    ret = slice_from_s(z, 1, s_13); /* <-, line 80 */
                    if (ret < 0) return ret;
                }
                break;
            case 4:
...
static int r_standard_suffix(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 2:
            ...
            {   int m = z->l - z->c; (void) m; /* try, line 100 */
                z->ket = z->c; /* [, line 100 */
                if (!(eq_s_b(z, 2, s_14))) { z->c = z->l - m; goto lab0; }
                z->bra = z->c; /* ], line 100 */
                {   int m = z->l - z->c; (void) m; /* or, line 100 */
                    {   int ret = r_R2(z);
                        if (ret == 0) goto lab2; /* call R2, line 100 */
                        if (ret < 0) return ret;
                    }
                    {   int ret;
                        ret = slice_del(z); /* delete, line 100 */
                        if (ret < 0) return ret;
                    }
                    goto lab1;
                lab2:
                    z->c = z->l - m;
                    {   int ret;
                        ret = slice_from_s(z, 3, s_15); /* <-, line 100 */
                        if (ret < 0) return ret;
                    }
                }
            lab1:
        ...
        case 3:
            ...
            {   int ret;
                ret = slice_from_s(z, 3, s_16); /* <-, line 104 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret;
                ret = slice_from_s(z, 1, s_17); /* <-, line 107 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            {   int ret;
                ret = slice_from_s(z, 3, s_18); /* <-, line 110 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            ...
            {   int m = z->l - z->c; (void) m; /* try, line 115 */
                ...
                switch(among_var) {
                    ...
                    case 1:
                        {   int ret = r_R2(z);
                            if (ret == 0) { z->c = z->l - m; goto lab3; } /* call R2, line 117 */
                            if (ret < 0) return ret;
                        }
                        {   int ret;
                        ...
                        break;
                    case 2:
                        {   int m = z->l - z->c; (void) m; /* or, line 118 */
                            {   int ret = r_R2(z);
                                if (ret == 0) goto lab5; /* call R2, line 118 */
                                if (ret < 0) return ret;
                            }
                            {   int ret;
                                ret = slice_del(z); /* delete, line 118 */
                                if (ret < 0) return ret;
                            }
                            goto lab4;
                        lab5:
                            z->c = z->l - m;
                            {   int ret = r_R1(z);
                                if (ret == 0) { z->c = z->l - m; goto lab3; } /* call R1, line 118 */
                                if (ret < 0) return ret;
                            }
                            {   int ret;
                                ret = slice_from_s(z, 3, s_20); /* <-, line 118 */
                                if (ret < 0) return ret;
                            }
                        }
                    lab4:
                    ...
                    case 3:
                        {   int ret = r_R2(z);
                            if (ret == 0) { z->c = z->l - m; goto lab3; } /* call R2, line 120 */
                            if (ret < 0) return ret;
                        }
                        {   int ret;
                    ...
                    case 4:
                        {   int ret = r_RV(z);
                            if (ret == 0) { z->c = z->l - m; goto lab3; } /* call RV, line 122 */
                            if (ret < 0) return ret;
                        }
                        {   int ret;
                            ret = slice_from_s(z, 1, s_21); /* <-, line 122 */
                            if (ret < 0) return ret;
                        }
                        break;
                }
        ...
        case 7:
            ...
            {   int m = z->l - z->c; (void) m; /* try, line 130 */
                z->ket = z->c; /* [, line 131 */
                if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((4198408 >> (z->p[z->c - 1] & 0x1f)) & 1)) { z->c = z->l - m; goto lab6; }
                ...
                switch(among_var) {
                    ...
                    case 1:
                        {   int m = z->l - z->c; (void) m; /* or, line 132 */
                            {   int ret = r_R2(z);
                        ...
                        lab8:
                            z->c = z->l - m;
                            {   int ret;
                                ret = slice_from_s(z, 3, s_22); /* <-, line 132 */
                                if (ret < 0) return ret;
                            }
                        }
                    lab7:
                    ...
                    case 2:
                        ...
                        lab10:
                            z->c = z->l - m;
                            {   int ret;
                                ret = slice_from_s(z, 3, s_23); /* <-, line 133 */
                                if (ret < 0) return ret;
                            }
                        }
                    lab9:
                    ...
                    case 3:
                        {   int ret = r_R2(z);
                            if (ret == 0) { z->c = z->l - m; goto lab6; } /* call R2, line 134 */
                            if (ret < 0) return ret;
                        }
                        {   int ret;
        ...
        case 8:
            ...
            {   int m = z->l - z->c; (void) m; /* try, line 142 */
                ...
                z->bra = z->c; /* ], line 142 */
                {   int ret = r_R2(z);
                    if (ret == 0) { z->c = z->l - m; goto lab11; } /* call R2, line 142 */
                    if (ret < 0) return ret;
                }
                {   int ret;
                ...
                z->bra = z->c; /* ], line 142 */
                {   int m = z->l - z->c; (void) m; /* or, line 142 */
                    {   int ret = r_R2(z);
                ...
                lab13:
                    z->c = z->l - m;
                    {   int ret;
                        ret = slice_from_s(z, 3, s_26); /* <-, line 142 */
                        if (ret < 0) return ret;
                    }
                }
            lab12:
        ...
        case 9:
            {   int ret;
                ret = slice_from_s(z, 3, s_27); /* <-, line 144 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            ...
            {   int ret;
                ret = slice_from_s(z, 2, s_28); /* <-, line 145 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int m = z->l - z->c; (void) m; /* or, line 147 */
                {   int ret = r_R2(z);
            ...
            lab15:
                ...
                {   int ret;
                    ret = slice_from_s(z, 3, s_29); /* <-, line 147 */
                    if (ret < 0) return ret;
                }
            }
        lab14:
        ...
        case 13:
            ...
            {   int ret;
                ret = slice_from_s(z, 3, s_30); /* <-, line 155 */
                if (ret < 0) return ret;
            }
        ...
        case 14:
            ...
            {   int ret;
                ret = slice_from_s(z, 3, s_31); /* <-, line 156 */
                if (ret < 0) return ret;
            }
...
static int r_i_verb_suffix(struct SN_env * z) {
    ...
    {   int m3; /* setlimit, line 163 */
        ...
        z->c = z->l - m;
        z->ket = z->c; /* [, line 164 */
        if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((68944418 >> (z->p[z->c - 1] & 0x1f)) & 1)) { z->lb = m3; return 0; }
...
static int r_verb_suffix(struct SN_env * z) {
    ...
    {   int m3; /* setlimit, line 174 */
        ...
        switch(among_var) {
            ...
            case 1:
                {   int ret = r_R2(z);
                    if (ret == 0) { z->lb = m3; return 0; } /* call R2, line 177 */
                    if (ret < 0) return ret;
                }
                {   int ret;
            ...
            case 3:
                ...
                {   int m = z->l - z->c; (void) m; /* try, line 191 */
                    z->ket = z->c; /* [, line 191 */
...
static int r_residual_suffix(struct SN_env * z) {
    int among_var;
    {   int m = z->l - z->c; (void) m; /* try, line 199 */
        z->ket = z->c; /* [, line 199 */
    ...
    {   int m3; /* setlimit, line 200 */
        ...
        switch(among_var) {
            ...
            case 1:
                {   int ret = r_R2(z);
                    if (ret == 0) { z->lb = m3; return 0; } /* call R2, line 202 */
                    if (ret < 0) return ret;
                }
                {   int m = z->l - z->c; (void) m; /* or, line 202 */
            ...
            case 2:
                {   int ret;
                    ret = slice_from_s(z, 1, s_36); /* <-, line 204 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
...
static int r_un_double(struct SN_env * z) {
    {   int m_test = z->l - z->c; /* test, line 212 */
        if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((1069056 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0;
    ...
    z->bra = z->c; /* ], line 212 */
    {   int ret;
        ret = slice_del(z); /* delete, line 212 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
lab1:
    z->bra = z->c; /* ], line 217 */
    {   int ret;
        ret = slice_from_s(z, 1, s_40); /* <-, line 217 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
extern int french_UTF_8_stem(struct SN_env * z) {
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 227 */
        {   int m = z->l - z->c; (void) m; /* or, line 237 */
            {   int m = z->l - z->c; (void) m; /* and, line 233 */
                {   int m = z->l - z->c; (void) m; /* or, line 229 */
            ...
            lab5:
                z->c = z->l - m;
                {   int m = z->l - z->c; (void) m; /* try, line 234 */
                    z->ket = z->c; /* [, line 234 */
                    {   int m = z->l - z->c; (void) m; /* or, line 234 */
                        if (!(eq_s_b(z, 1, s_41))) goto lab10;
                        z->bra = z->c; /* ], line 234 */
                        {   int ret;
                            ret = slice_from_s(z, 1, s_42); /* <-, line 234 */
                            if (ret < 0) return ret;
                        }
                        goto lab9;
                    lab10:
                        ...
                        z->bra = z->c; /* ], line 235 */
                        {   int ret;
                            ret = slice_from_s(z, 1, s_44); /* <-, line 235 */
                            if (ret < 0) return ret;
                        }
                    }
                lab9:
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 243 */
    ...
    {   int m = z->l - z->c; (void) m; /* do, line 244 */
