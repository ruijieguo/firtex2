...
static int r_mark_regions(struct SN_env * z) {
    ...
    lab1:
        ...
        while(1) { /* gopast, line 43 */
            if (!(in_grouping_U(z, g_v, 97, 121))) goto lab5;
            break;
        lab5:
            {   int c = skip_utf8(z->p, z->c, 0, z->l, 1);
                if (c < 0) goto lab0;
                z->c = c; /* gopast, line 43 */
            }
        }
        while(1) { /* gopast, line 43 */
...
static int r_shortv(struct SN_env * z) {
    {   int m = z->l - z->c; (void) m; /* or, line 51 */
...
static int r_Step_1a(struct SN_env * z) {
    int among_var;
    {   int m = z->l - z->c; (void) m; /* try, line 59 */
        z->ket = z->c; /* [, line 60 */
        if (z->c <= z->lb || (z->p[z->c - 1] != 39 && z->p[z->c - 1] != 115)) { z->c = z->l - m; goto lab0; }
    ...
    switch(among_var) {
        ...
        case 1:
            {   int ret;
                ret = slice_from_s(z, 2, s_5); /* <-, line 66 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int m = z->l - z->c; (void) m; /* or, line 68 */
                {   int c = skip_utf8(z->p, z->c, z->lb, z->l, - 2);
                    if (c < 0) goto lab2;
                    z->c = c; /* hop, line 68 */
                }
                {   int ret;
                    ret = slice_from_s(z, 1, s_6); /* <-, line 68 */
                    if (ret < 0) return ret;
                }
                goto lab1;
            lab2:
                z->c = z->l - m;
                {   int ret;
                    ret = slice_from_s(z, 2, s_7); /* <-, line 68 */
                    if (ret < 0) return ret;
                }
            }
        lab1:
...
static int r_Step_1b(struct SN_env * z) {
    int among_var;
    z->ket = z->c; /* [, line 75 */
    if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((33554576 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0;
    ...
    switch(among_var) {
        ...
        case 1:
            ...
            {   int ret;
                ret = slice_from_s(z, 2, s_8); /* <-, line 77 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int m_test = z->l - z->c; /* test, line 80 */
                while(1) { /* gopast, line 80 */
                    if (!(in_grouping_b_U(z, g_v, 97, 121))) goto lab0;
                    break;
                lab0:
                    {   int c = skip_utf8(z->p, z->c, z->lb, 0, -1);
                        if (c < 0) return 0;
                        z->c = c; /* gopast, line 80 */
                    }
                }
                z->c = z->l - m_test;
            }
            ...
            {   int m_test = z->l - z->c; /* test, line 81 */
                if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((68514004 >> (z->p[z->c - 1] & 0x1f)) & 1)) among_var = 3; else
            ...
            switch(among_var) {
                ...
                case 1:
                    {   int ret;
                        {   int c = z->c;
                            ret = insert_s(z, z->c, z->c, 1, s_9); /* <+, line 83 */
                            z->c = c;
                        }
                        if (ret < 0) return ret;
                    }
                ...
                case 3:
                    ...
                    {   int ret;
                        {   int c = z->c;
                            ret = insert_s(z, z->c, z->c, 1, s_10); /* <+, line 87 */
                            z->c = c;
                        }
                        if (ret < 0) return ret;
                    }
...
static int r_Step_1c(struct SN_env * z) {
    z->ket = z->c; /* [, line 94 */
    {   int m = z->l - z->c; (void) m; /* or, line 94 */
...
lab0:
    z->bra = z->c; /* ], line 94 */
    if (!(out_grouping_b_U(z, g_v, 97, 121))) return 0;
    {   int m = z->l - z->c; (void) m; /* not, line 95 */
    ...
    {   int ret;
        ret = slice_from_s(z, 1, s_13); /* <-, line 96 */
        if (ret < 0) return ret;
    }
    return 1;
}
...
static int r_Step_2(struct SN_env * z) {
    int among_var;
    z->ket = z->c; /* [, line 100 */
    if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((815616 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0;
    ...
    switch(among_var) {
        ...
        case 1:
            {   int ret;
                ret = slice_from_s(z, 4, s_14); /* <-, line 101 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret;
                ret = slice_from_s(z, 4, s_15); /* <-, line 102 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret;
                ret = slice_from_s(z, 4, s_16); /* <-, line 103 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret;
                ret = slice_from_s(z, 4, s_17); /* <-, line 104 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
        ...
        case 6:
            {   int ret;
                ret = slice_from_s(z, 3, s_19); /* <-, line 107 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
        ...
        case 8:
            {   int ret;
                ret = slice_from_s(z, 2, s_21); /* <-, line 111 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int ret;
                ret = slice_from_s(z, 3, s_22); /* <-, line 112 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret;
                ret = slice_from_s(z, 3, s_23); /* <-, line 114 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret;
                ret = slice_from_s(z, 3, s_24); /* <-, line 116 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret;
                ret = slice_from_s(z, 3, s_25); /* <-, line 118 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            ...
            {   int ret;
                ret = slice_from_s(z, 2, s_27); /* <-, line 119 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
            {   int ret;
                ret = slice_from_s(z, 3, s_28); /* <-, line 120 */
                if (ret < 0) return ret;
            }
            break;
        case 15:
            {   int ret;
                ret = slice_from_s(z, 4, s_29); /* <-, line 121 */
                if (ret < 0) return ret;
            }
            break;
        case 16:
...
static int r_Step_3(struct SN_env * z) {
    int among_var;
    z->ket = z->c; /* [, line 127 */
    if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((528928 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0;
    ...
    switch(among_var) {
        ...
        case 1:
            {   int ret;
                ret = slice_from_s(z, 4, s_30); /* <-, line 128 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret;
                ret = slice_from_s(z, 3, s_31); /* <-, line 129 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret;
                ret = slice_from_s(z, 2, s_32); /* <-, line 130 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret;
                ret = slice_from_s(z, 2, s_33); /* <-, line 132 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
...
static int r_Step_4(struct SN_env * z) {
    int among_var;
    z->ket = z->c; /* [, line 141 */
    if (z->c <= z->lb || z->p[z->c - 1] >> 5 != 3 || !((1864232 >> (z->p[z->c - 1] & 0x1f)) & 1)) return 0;
...
static int r_Step_5(struct SN_env * z) {
    ...
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   int m = z->l - z->c; (void) m; /* or, line 151 */
                {   int ret = r_R2(z);
            ...
            lab1:
                ...
                {   int m = z->l - z->c; (void) m; /* not, line 151 */
                    {   int ret = r_shortv(z);
...
static int r_exception2(struct SN_env * z) {
    z->ket = z->c; /* [, line 158 */
    if (z->c <= z->lb || (z->p[z->c - 1] != 100 && z->p[z->c - 1] != 103)) return 0;
...
static int r_exception1(struct SN_env * z) {
    ...
    switch(among_var) {
        ...
        case 1:
            {   int ret;
                ret = slice_from_s(z, 3, s_37); /* <-, line 174 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret;
                ret = slice_from_s(z, 3, s_38); /* <-, line 175 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret;
                ret = slice_from_s(z, 3, s_39); /* <-, line 176 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret;
                ret = slice_from_s(z, 3, s_40); /* <-, line 177 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret;
                ret = slice_from_s(z, 3, s_41); /* <-, line 178 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret;
                ret = slice_from_s(z, 3, s_42); /* <-, line 182 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret;
                ret = slice_from_s(z, 5, s_43); /* <-, line 183 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret;
                ret = slice_from_s(z, 4, s_44); /* <-, line 184 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            {   int ret;
                ret = slice_from_s(z, 5, s_45); /* <-, line 185 */
                if (ret < 0) return ret;
            }
            break;
        case 10:
            {   int ret;
                ret = slice_from_s(z, 4, s_46); /* <-, line 186 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret;
                ret = slice_from_s(z, 5, s_47); /* <-, line 187 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_postlude(struct SN_env * z) {
    ...
    while(1) { /* repeat, line 203 */
        ...
        {   int ret;
            ret = slice_from_s(z, 1, s_49); /* <-, line 203 */
            if (ret < 0) return ret;
        }
        continue;
    lab0:
...
extern int english_UTF_8_stem(struct SN_env * z) {
    ...
    lab2:
        ...
        {   int m = z->l - z->c; (void) m; /* or, line 215 */
        ...
        lab8:
            ...
            {   int m = z->l - z->c; (void) m; /* do, line 222 */
                {   int ret = r_Step_4(z);
            ...
            {   int m = z->l - z->c; (void) m; /* do, line 224 */
                {   int ret = r_Step_5(z);
